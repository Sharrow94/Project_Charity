                        ...
                        <c:forEach items="${users}" var="user">
                            <tr role="row" class="odd">
                                ...
                                <td style="white-space: nowrap">
                                    <sec:authorize access="hasRole('ADMIN')">
                                        <a href='<c:url value="/admin/admin/edit/${user.id}"/>'
                                           class="btn btn-primary"
                                        ...
                                        <a href='<c:url value="/admin/makeAdmin/${user.id}"/>'
                                           class="btn btn-primary"
                                           style="background-color:#f6c23e; border-color:#f6c23e;color:#3a3b45">Nadaj uprawnienia</a>
                                        <c:if test="${user.enabled==true}">
                                            <a href='<c:url value="/admin/user/block/${user.id}"/>'
                                               class="btn btn-primary"
                                               style="background-color:#f6c23e; border-color:#f6c23e;color:#3a3b45">Zablokuj</a>
                                        </c:if>
                                        <c:if test="${user.enabled==false}">
                                            <a href='<c:url value="/admin/user/block/${user.id}"/>'
                                               class="btn btn-primary"
                                               style="background-color:#f6c23e; border-color:#f6c23e;color:#3a3b45">Odblokuj</a>
                                        </c:if>
