                    ...
                    <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0"
                        ...
                        <c:forEach items="${admins}" var="admin">
                            <tr role="row" class="odd">
                                ...
                                <td>
                                    <sec:authorize access="hasRole('ADMIN')">
                                        <a href='<c:url value="/admin/admin/edit/${admin.id}"/>'
                                           class="btn btn-primary"
                                           style="background-color:#f6c23e; border-color:#f6c23e;color:#3a3b45">Edytuj</a>
                                        <a href='<c:url value="/admin/admin/delete/${admin.id}"/>'
                                           class="btn btn-primary"
                                           style="background-color:#f6c23e; border-color:#f6c23e;color:#3a3b45">Usuń</a>
                                        <a href='<c:url value="/admin/makeAdmin/${admin.id}"/>'
                                           class="btn btn-primary"
                                           style="background-color:#f6c23e; border-color:#f6c23e;color:#3a3b45">Odbierz uprawnienia</a>
                                    </sec:authorize>
                                </td>
